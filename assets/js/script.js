...
var createTaskEl = function(taskDataObj) {
    ...
    taskInfoEl.innerHTML = "<h3 class='task-name'>" + taskDataObj.name + "</h3><span class='task-type'>" + taskDataObj.type + "</span>" // add HTML to div
...
var loadTasks = function() {
    ...
    for (var i = 0; i < tasks.length; i++) {
        tasks[i].id = taskIdCounter; // set ID value
        var listItemEl = document.createElement("li"); // create li element
        listItemEl.className = "task-item"; // set li class
        listItemEl.setAttribute("data-task-id", tasks[i].id) // set li ID
